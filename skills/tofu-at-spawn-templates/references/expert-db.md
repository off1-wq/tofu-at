...
> 30개 도메인 155명 전문가 + resolve_expert() 알고리즘

---

## 7.5 전문가 도메인 프라이밍 (완전 내장형)

> **30개 도메인 155명 전문가**가 아래에 완전 내장되어 외부 파일 없이 작동합니다.
...
| 4.28 | AI/LLM/프롬프트 엔지니어링 | LLM, large language model, prompt, prompt engineering, GPT, transformer, fine-tuning, RAG, embedding, token, chain-of-thought, few-shot, in-context learning, alignment, inference, context window |
| 4.29 | 보안/사이버보안 | security, cybersecurity, vulnerability, exploit, penetration, pentest, threat, encryption, cryptography, malware, infosec, CVE, authentication, firewall, breach, hardening, audit |
| 4.30 | DevOps/클라우드/인프라 | devops, kubernetes, docker, container, CI/CD, deployment, infrastructure, cloud, AWS, terraform, observability, SRE, orchestration, monitoring, provisioning, scaling |

### 7.5.4 전문가 데이터베이스 (30도메인 155명)
...
#### 4.28 AI/LLM/프롬프트 엔지니어링

| 전문가 | 전문 분야 | 핵심 용어/프레임워크 |
|--------|----------|---------------------|
| Yann LeCun | 딥러닝 아키텍처 | Convolutional Networks, Self-Supervised Learning, Energy-Based Models, World Models |
| Yoshua Bengio | 딥러닝 이론 | Representation Learning, Attention Mechanisms, Generative Models, Curriculum Learning |
| Ilya Sutskever | 대규모 LLM | Sequence-to-Sequence, Scaling Laws, GPT Architecture, Next-Token Prediction |
| Dario Amodei | AI 정렬/스케일링 | Constitutional AI, Scaling Laws, Responsible Scaling Policy, RLHF |
| Jason Wei | LLM 추론 | Chain-of-Thought, Emergent Abilities, Instruction Tuning, Self-Consistency |
| Riley Goodside | 프롬프트 엔지니어링 | Prompt Injection, Few-Shot Prompting, System Prompt Design, In-Context Learning |

#### 4.29 보안/사이버보안

| 전문가 | 전문 분야 | 핵심 용어/프레임워크 |
|--------|----------|---------------------|
| Bruce Schneier | 보안 이론/암호학 | Applied Cryptography, Threat Modeling, Security Economics, Defense in Depth |
| Dan Kaminsky | 네트워크 보안 | DNS Security, Protocol Vulnerabilities, Cache Poisoning |
| Katie Moussouris | 취약점 공개 | Bug Bounty, Coordinated Vulnerability Disclosure, Vulnerability Markets |
| Mikko Hyppönen | 멀웨어/위협 분석 | Malware Analysis, Threat Intelligence, Cyber Warfare, Hyppönen's Law |
| Troy Hunt | 데이터 유출/웹보안 | Have I Been Pwned, Credential Stuffing, Web Security, Breach Analysis |
| Window Snyder | 제품 보안 | Secure Development Lifecycle, Threat Modeling, Attack Surface Reduction |

#### 4.30 DevOps/클라우드/인프라

| 전문가 | 전문 분야 | 핵심 용어/프레임워크 |
|--------|----------|---------------------|
| Gene Kim | DevOps 문화 | The Phoenix Project, Three Ways, DORA Metrics, Continuous Delivery |
| Kelsey Hightower | 클라우드 네이티브 | Kubernetes, Container Orchestration, Infrastructure as Code, GitOps |
| Nicole Forsgren | DevOps 성과측정 | DORA Metrics, Accelerate, Four Key Metrics, Deployment Frequency |
| Charity Majors | 관측가능성 | Observability, High-Cardinality Telemetry, Production Engineering, SLOs |
| Adrian Cockcroft | 클라우드 아키텍처 | Microservices, Cloud Migration, Chaos Engineering, Resilience Patterns |
| Jez Humble | 지속적 전달 | Continuous Delivery, Deployment Pipeline, Lean Enterprise, Trunk-Based Development |
